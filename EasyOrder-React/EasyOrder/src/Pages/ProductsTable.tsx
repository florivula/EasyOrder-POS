...
const ProductsTable: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', height: '100vh', background: '#1f2021', padding: '20px' }}>
      <div style={{ width: '65%', maxWidth: '1200px', background: 'white', borderCollapse: 'collapse', borderRadius: '10px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)', overflow: 'hidden' }}>
        <div style={{ maxHeight: '60vh', overflowY: 'auto' }}>
          <table style={{ color: '#333', width: '100%', borderCollapse: 'collapse' }}>
            <thead>
